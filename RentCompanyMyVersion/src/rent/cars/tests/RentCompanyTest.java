...
import rent.cars.dao.AbstractRentCompany;
import rent.cars.dao.IRentCompany;
import rent.cars.dao.RentCompany;
...
class RentCompanyTest {
	...
	void setUp() throws Exception {
		...
		rentRecord = new RentRecord(LICENSE1, REG_NUMBER1, RENT_DATE1, RETURN_DATE);
	}

	@Test
	void testAddCar() {
		assertEquals(CarsReturnCode.CAR_EXIST,
				company.addCar(car1));
	...
	@Test
	void testAddDriver() {
		assertEquals(CarsReturnCode.DRIVER_EXIST,company.addDriver(driver1));
	...
	@Test
	void testRemoveCar() {
		assertEquals(CarsReturnCode.CAR_NOT_EXIST, company.removeCar(REG_NUMBER2));
		...
		assertTrue(car1.isFlRemoved());
		assertEquals(CarsReturnCode.CAR_NOT_EXIST, company.rentCar(REG_NUMBER1, LICENSE1, 
