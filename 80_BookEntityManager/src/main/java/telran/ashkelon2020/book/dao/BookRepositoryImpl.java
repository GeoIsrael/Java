...
//		Query countQuery = em.createQuery("select count(b) from Book b join b.authors a where a.name=?1");
//		countQuery.setParameter(1, authorName);
//		long count = countQuery.getResultStream().count();
