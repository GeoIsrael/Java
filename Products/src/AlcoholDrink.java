...
public class AlcoholDrink extends Drink {
	...
	public AlcoholDrink(String name, double price, String mItem, int code, String expDate, double calories,
			boolean isKosher, boolean isNatural, boolean isSparkling, double percentAlcohol) {
		super(name, price, mItem, code, expDate, calories, isKosher, isNatural, isSparkling);
	...
	public void setPercentAlcohol(double percentAlcohol) {
		if (percentAlcohol > 0 && percentAlcohol < 100) this.percentAlcohol = percentAlcohol;
		else this.percentAlcohol = 0;
	}
	...
	public String toString() {
		return "AlcoholDrink [name=" + getName() + ", price="  + getPrice() + ", mItem=" + getmItem() + ", code=" 
	         + getCode() + ", ExpDate=" + getExpDate() + ", calories()=" + getCalories() + ", isKosher=" + isKosher() +
	          ", isNatural=" + isNatural()  + ", isSparkling=" + isSparkling()  + 
	            ", PercentAlcohol=" + getPercentAlcohol() +  "]";
	}
